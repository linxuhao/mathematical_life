...
(AUC $0.58$)---so a small precursor component (the hidden state ``thinking wrong'' before the
visible error) is disfavored by everything we measured, but not excluded. The intra-trace topological signal thus decomposes exactly into the two
